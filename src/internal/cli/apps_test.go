...
func (f *cliFakeStore) SumInertBytesByTeam(_ context.Context, _ string) (int64, error) {
	return 0, nil
}

// CountPinnedByTeam satisfies the appsStore interface (M6.20 quota).
func (f *cliFakeStore) CountPinnedByTeam(_ context.Context, _ string) (int, error) { return 0, nil }

// CountTeamUploadsSince satisfies the appsStore interface (M6.20 quota).
func (f *cliFakeStore) CountTeamUploadsSince(_ context.Context, _ string, _ time.Time) (int, error) {
	return 0, nil
}
